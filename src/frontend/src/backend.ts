...
import type { Category as _Category, Complaint as _Complaint, ComplaintRequest as _ComplaintRequest, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async assignComplaint(arg0: bigint, arg1: Principal, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignComplaint(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAssignedComplaints(): Promise<Array<Complaint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAssignedComplaints();
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getComplaintsByCategory(arg0: Category): Promise<Array<Complaint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getComplaintsByCategory(to_candid_Category_n21(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitComplaint(arg0: ComplaintRequest): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitComplaint(await to_candid_ComplaintRequest_n23(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Complaint]): Promise<Complaint | null> {
    return value.length === 0 ? null : await from_candid_Complaint_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        assignedWorkerId: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.assignedWorkerId)),
        updatedAt: value.updatedAt,
        category: value.category,
        photo: record_opt_to_undefined(await from_candid_opt_n14(_uploadFile, _downloadFile, value.photo)),
        assignedWorkerName: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.assignedWorkerName))
    };
}
...
async function to_candid_ComplaintRequest_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ComplaintRequest): Promise<_ComplaintRequest> {
...
async function to_candid_record_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        area: value.area,
        description: value.description,
        category: to_candid_Category_n21(_uploadFile, _downloadFile, value.category),
...
function to_candid_variant_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.other ? {
        ...
        electricity: null
    } : value == Category.road_damage ? {
        road_damage: null
    } : value == Category.water_leakage ? {
        water_leakage: null
    } : value;
}
